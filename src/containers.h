...
public:
     LiteralIndexedVector(unsigned size = 0): vector<_T>(size*2){}
     LiteralIndexedVector(unsigned size, const typename vector<_T>::value_type& __value): vector<_T>(size*2, __value){}
     ...
     inline typename vector<_T>::iterator begin(){ return vector<_T>::begin()+2;}
